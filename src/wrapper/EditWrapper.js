  ...
  render() {
    ...
    return connectDragSource(
      <div
        style={{...item.style, ...{
          position: 'relative',
          outline: layoutState.selectedItem === id ? '2px solid rgba(25, 230, 240, 1)' : hovered ? '1px solid rgba(0,0,0,0.3)' : '1px solid rgba(0,0,0,0.1)',
          outlineOffset: layoutState.selectedItem === id ? -2 : -1
        }}}
