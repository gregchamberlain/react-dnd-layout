...
const LayoutForm = object({
  ...
  borderWidth: ({onChange, value}) => <StyleInput value={value} onChange={onChange} label="Border Width"/>,
  borderStyle: select(['none', 'hidden', 'dotted', 'dashed', 'solid', 'double', 'groove', 'ridge', 'inset', 'outset', 'initial', 'inherit'], {label: 'Border Style'}),
  borderRadius: ({onChange, value}) => <StyleInput value={value} onChange={onChange} label="Border Radius"/>,
