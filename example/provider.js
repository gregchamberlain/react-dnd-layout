...
class StatelessExample extends Component {
  ...
  render() {
    return (
      <LayoutProvider items={items} components={comps} onChange={i => console.log(i)}/>
    );
  }
}
